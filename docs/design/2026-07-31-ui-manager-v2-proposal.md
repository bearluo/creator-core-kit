---
状态: 已实施（2026-07-31，封存）  # 草案 → 评审中 → 已定稿 → 已实施
类型: 改造提案（过程文档，一次性）——结论已并入 `packages/core/docs/modules/ui-manager.md`（现状）+ `docs/adr/0008-fixed-ui-layer-enum.md`（决策 7'）。**本文只作沿革留存，不再更新**；查当前功能请读模块文档。
