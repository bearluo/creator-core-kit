...
import { MAX_CLIP_VERTICES, planFixedLayout, writeFixedFrame } from '../assets/scripts/SpineVatFixedLayout';
import type { FixedFrame, FixedKeyRange } from '../assets/scripts/SpineVatFixedBaker';
